...
import (
	...
	"github.com/robertwitt/go-tutorial-messaging/src/distributed/web/model"
...
func (wsc *websocketController) listenForSources() {
	...
	wsc.ch.QueueBind(q.Name, "", qutils.WebappSourceExchange, false, nil)
...
func (wsc *websocketController) listenForDiscoveryRequests(socket *websocket.Conn) {
	for {
		...
		if msg.Type == "discover" {
			wsc.ch.Publish("", qutils.WebappDiscoveryQueue, false, false, amqp.Publishing{})
		}
	}
}
